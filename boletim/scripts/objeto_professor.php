	...
	if (isset($_POST['acao']))
{
	...
	switch ($action)
	{
			...
			$professor->insert_professor($nome, $email, $cod_cidade, $cod_bairro, $cod_rua, $complemento, $numero, $cod_uf, $telefone, $cod_status,$cod_instituicao,$cep,$identidade);
			...
			$professor->update_professor($nome, $email, $cod_cidade, $cod_bairro, $cod_rua, $complemento, $numero, $cod_uf, $telefone, $cod_status,$cod_professor,$cod_instituicao,$cep,$identidade);

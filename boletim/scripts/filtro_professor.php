...
$query_cons = mysql_query("SELECT cod_professor, nome FROM professor WHERE cod_instituicao = '$cod_instituicao' AND cod_status = 1 AND nome LIKE '$opcao%' ORDER BY nome",$conn);
$i=0;

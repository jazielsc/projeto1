...
class Class_curso
{
     ...
     public function select_curso($cod_curso){
         ...
         $query_select = mysql_query("SELECT curso.nome, curso.cod_instituicao, instituicao.nome, curso.tipo  FROM curso, instituicao WHERE curso.cod_instituicao = instituicao.cod_instituicao AND curso.cod_curso = '$cod_curso'") or die (mysql_error(). "erro em select");

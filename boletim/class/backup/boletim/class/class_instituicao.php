...
$query_insert = mysql_query("INSERT INTO config VALUE (7,2,30,'$resultado[0]')") or die ("Erro insert ". mysql_errno());
	...
	{	
     ...
     public function update_config($media,$cod_tipo,$ranking)
     {
         ...
         $cod_instituicao = (int) $_SESSION['id_instituicao'];
                     ...
                     $query_insert = mysql_query("UPDATE config SET media = '$media', cod_tipo = '$cod_tipo', ranking = '$ranking' WHERE cod_instituicao = '$cod_instituicao'") or die ("Erro insert ". mysql_error());

	...
	if (isset($_POST['acao'])){
		...
		switch ($action){
			case "insert_curso":{
				...
				header("Location: /paginas/cadastro_curso.php?sucesso=0");
			} break;
			...
			case "update_curso":{
				...
				header("Location: /paginas/cadastro_curso.php?sucesso=1");
			} break;
			...
			case "delete_curso":{
				...
				$res = $curso->delete_curso($codigo);
				header("Location: /paginas/cadastro_curso.php?sucesso=".$res);
			} break;
		}
	}
?>

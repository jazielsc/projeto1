...
$query_autor = mysql_query("SELECT cod_curso, nome, tipo FROM curso WHERE cod_instituicao = '$cod_instituicao' ORDER BY nome",$conn);
...
while ($result_autor = mysql_fetch_array($query_autor)){
	...
	echo "&nome$i=$result_autor[1] - $result_autor[2]";

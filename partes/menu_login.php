...
<div>
	...
	<div id="dados_login">
		<table>
			<tr>
				<td style="color: red;">Área Restrita:</td>
	...
	<nav id="menu">
		<div id="menu">
			<ul>
				<li><a href="/paginas/principal.php">INÍCIO</a></li>
				<li><a href="#">CADASTRO</a>
					<ul>
						...
						<li><a href="/paginas/cadastro_funcionario.php">&nbsp;&nbsp;&nbsp;FUNCIONÁRIO</a></li>
					</ul>
				</li>
				...
				<li><a href="#">RELATÓRIO</a>
					<ul>
						...
						<li><a href="#">&nbsp;&nbsp;&nbsp;TURMA/HORÁRIO</a></li>
						<li><a href="#">&nbsp;&nbsp;&nbsp;TURMA/PROVA</a></li>
						<li><a href="#">&nbsp;&nbsp;&nbsp;DISCIPLINA/ALUNO</a></li>
						<li><a href="#">&nbsp;&nbsp;&nbsp;PROFESSOR/DISCIPLINA</a></li>
						<li><a href="#">&nbsp;&nbsp;&nbsp;PROFESSOR/HORÁRIO</a></li>

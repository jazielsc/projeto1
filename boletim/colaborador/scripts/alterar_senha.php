...
$query_cidade = mysql_query("SELECT cod_colaborador FROM colaborador WHERE senha = '$txt_senha'",$conn) or die ("Error na consulta");
...
// alterando registros
$query = mysql_query("UPDATE colaborador SET senha = '$txt_novasenha' WHERE cod_colaborador = '$cod'",$conn) or die("Error na altera��o");

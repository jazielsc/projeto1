	...
	if (isset($_POST['acao']))
{
	...
	require($_SERVER['DOCUMENT_ROOT']."/boletim/versaofree/scripts/seguranca.php");
	require($_SERVER['DOCUMENT_ROOT']."/boletim/versaofree/class/class_colaborador.php");
	...
	switch ($action)
	{
			...
			$colaborador->insert_colaborador($nome,$email,$cod_cidade,$cod_bairro,$cod_rua,$complemento,$numero,$cod_uf,$telefone,$celular,$cod_status,$cep,$login,$senha);
                        
                        echo"&resultado=$colaborador->resultado";

		        break;

                        case "select_grid_professor":

                        $professor->select_grid_professor();

...
$query_select = mysql_query("SELECT email FROM colaborador WHERE email = '$txt_email'");
...
// alterando registros
$query = mysql_query("UPDATE colaborador SET email = '$txt_email' WHERE cod_colaborador = '$cod'",$conn) or die("Error na altera��o");

	 ...
	 $quant = mysql_num_rows($query_select);
		...
		// se retornou então envia a mensagem
            if ($quant > 0 )
            {
                 ...
                 {
                     $query_insert = mysql_query("INSERT INTO colaborador VALUE (NULL, '$nome','$email','$cod_cidade','$cod_bairro','$cod_rua','$complemento','$numero','$cod_uf','$telefone','$celular','$cod_status','$cep','$login','$senha')") or die ("Erro insert col ". mysql_error());

...
class Class_colaborador
{
     ...
     public function insert_colaborador($nome,$email,$cod_cidade,$cod_bairro,$cod_rua,$complemento,$numero,$cod_uf,$telefone,$celular,$cod_status,$cep,$login,$senha)
     {
         ...
         $query_select = mysql_query("SELECT cod_colaborador FROM colaborador WHERE email = '$email' or login = '$login'") or die ("Erro select ". mysql_errno());
	 ...
	 $quant = mysql_num_rows($query_select);
		...
		// se retornou então envia a mensagem
            if ($quant > 0 )
            {
                 ...
                 {
                     $query_insert = mysql_query("INSERT INTO colaborador VALUE (NULL, '$nome','$email','$cod_cidade','$cod_bairro','$cod_rua','$complemento','$numero','$cod_uf','$telefone','$celular','$cod_status','$cep','$login','$senha_cript')") or die ("Erro insert col ". mysql_error());
				...
				$mensagem .= "Voce foi cadastrado no sistema boletimflex, abaixo segue seus dados de acesso! <br /> <br />";
				$mensagem .= "<a href=\"http://www.boletimflex.com.br/boletim/colaborador/\">http://www.boletimflex.com.br/boletim/colaborador/</a><br /> <br />";

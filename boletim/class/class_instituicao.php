...
$query_cont1 = mysql_query("SELECT count(*) FROM instituicao, colaborador_instituicao WHERE colaborador_instituicao.cod_instituicao = instituicao.cod_instituicao") or die("Error na consulta". mysql_error());

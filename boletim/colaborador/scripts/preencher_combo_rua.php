...
// arquivo que preenche o combo rua no flash no formulário de cadastro de contratos
...
// variável vinda do flash com o código do bairro

$cod_bairro = $_POST['cod_bairro'];  
	
// consulta para retornar as informações das ruas

...
$query_select = mysql_query("SELECT login FROM colaborador WHERE login = '$txt_usuario'");
...
// alterando registros
$query = mysql_query("UPDATE colaborador SET login = '$txt_usuario' WHERE cod_colaborador = '$cod'",$conn) or die("Error na altera��o");

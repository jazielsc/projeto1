...
class Class_boletim
{
	 ...
	 public function insert_notas($nota_1,$nota_2,$nota_3,$nota_4,$nota_5,$nota_6,$numero_avaliacoes,$faltas,$cod_aluno,$cod_professor,$cod_curso,$cod_turma,$cod_disciplina,$unidade)
     {
     ...
     public function update_notas($nota_1,$nota_2,$nota_3,$nota_4,$nota_5,$nota_6,$numero_avaliacoes,$faltas,$cod_aluno,$cod_professor,$cod_curso,$cod_turma,$cod_disciplina,$codigo,$unidade)
     {
    ...
    $tabela = "";
     ...
     echo "&media_curso=$resultado[0]";
      ...
      $query_grid = mysql_query("SELECT cod_boletim, disciplina.nome, nota_01, nota_02, nota_03, nota_04, nota_05, nota_06, media, faltas FROM disciplina, boletim $tabela WHERE disciplina.cod_disciplina = boletim.cod_disciplina AND boletim.cod_curso = disciplina.cod_curso AND boletim.cod_turma = disciplina.cod_turma AND boletim.cod_curso = '$cod_curso' AND boletim.cod_turma = '$cod_turma' AND boletim.cod_aluno = '$cod_aluno' $where",$conn) or die ("Error na consulta1");
     ...
     include($_SERVER['DOCUMENT_ROOT']."/boletim/scripts/conecta.php");
      ...
      $query_grid = mysql_query("SELECT cod_boletim, aluno.nome, nota_01, nota_02, nota_03, nota_04, nota_05, nota_06, media, faltas, matricula, n_avaliacoes, unidade FROM aluno, boletim WHERE  aluno.cod_aluno = boletim.cod_aluno AND cod_boletim = '$cod_boletim'",$conn) or die ("Error na consulta1");
	...
	{	
     ...
     public function delete_notas($codigo,$cod_professor,$cod_curso,$cod_turma,$cod_disciplina){
...
public function select_grid_boletim_aluno($cod_aluno,$semestre){
